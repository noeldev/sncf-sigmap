...
- **Context menu**: right-click any signal for quick access to Zoom to, Pin/Unpin, Properties, and Share. All items display a colour-coded SVG icon (blue `var(--accent2)`) aligned in a fixed column — items without icons keep the column space so all labels align
