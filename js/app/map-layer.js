...
import { OVERVIEW_MAX_ZOOM } from '../core/config.js';
import { getTileUrlsForBounds, fetchTileByKey, findSignalLocation } from '../core/tiles.js';
import { t, onLangChange } from '../core/translation.js';
import { getPrimaryTypeColor } from '../domain/signal-mapping.js';
import { showContextMenu, closeContextMenu, isContextMenuOpen } from '../ui/context-menu.js';
import { isOwnWorkerMessage } from '../workers/tiles-worker-contract.js';
...
function _runWorker(bounds, tileUrls, zoom, sw, ne) {
    ...
    try {
        _worker = new Worker(new URL('../workers/tiles-worker.js', import.meta.url), { type: 'module' });
    } catch (err) {
