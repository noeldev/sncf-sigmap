 ...
 *
 * The caller (validate-main.js _detectConflicts) is responsible for:
 *   - Sorting feats after this call (originals first, outliers last).
 *   - Deleting the temporary _outlier flag before calling groupFeats().
 *
